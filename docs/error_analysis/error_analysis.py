'''
File: draw_curve copy.py
Project: error_analysis
Created Date: 2023-10-04 15:24:24
Author: chenkaixu
-----
Comment:
This script used to analysis the experiment results, especially for the the error classification.
...
-----
Last Modified: 2023-10-09 16:35:39
...
# prepare the data
video_path = '/workspace/data/split_pad_dataset_512/flod1/train/ASD/20160120_ASD_lat__V1-0001.mp4'

...
def get_parameters():
    ...
    # Transfor_learning
    parser.add_argument('--transfor_learning', type=bool, default=True, help='if use the transformer learning')
    # parser.add_argument('--fix_layer', type=str, default='all', choices=['all', 'head', 'stem_head', 'stage_head'], help="select the ablation study within the choices ['all', 'head', 'stem_head'].")
